...
import { type TargetDrive, DotYouClient, type SystemFileType } from '@homebase-id/js-lib/core';
import { getDecryptedThumbnailMeta, type ThumbnailMeta } from '@homebase-id/js-lib/media';
